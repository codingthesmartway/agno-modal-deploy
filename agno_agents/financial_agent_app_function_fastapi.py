"""
Financial Agent - Pattern 1: Function returning FastAPIApp

This file demonstrates the highest priority pattern where a function 
returns a complete FastAPIApp instance.
"""
...
def create_financial_agent() -> Agent:
    """Helper function to create the financial agent"""
    return Agent(
...
def create_fastapi_app() -> FastAPIApp:
    ...
    This function is self-contained and handles both agent creation
    and FastAPI app setup, making it perfect for generic deployment.
    """
